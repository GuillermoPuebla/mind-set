...
if __name__ == "__main__":
    image_path = (
        "data/obj_representation/leek_reppa_arguin_2005_dataset/imgs_upscaled_mod.png"
    )
    mask = "data/obj_representation/leek_reppa_arguin_2005_dataset/additional_mask.png"
    output = f"data/obj_representation/leek_reppa_arguin_2005_dataset"
