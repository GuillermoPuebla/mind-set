...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--generate_tomls", action="store_true", help="Generate toml files"
    )
    parser.add_argument(
        "--generate_datasets", action="store_true", help="Generate datasets"
    )
    parser.add_argument(
        "--publish_kaggle", action="store_true", help="Publish datasets on kaggle"
    )
