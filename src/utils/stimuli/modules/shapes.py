...
class Shapes(ShapeCoreFunctions):
    ...
    def add_arc(self, size, x=0.5, y=0.5, arc=50, width=0.3):
        ...
        canvas_inner = new(
            "RGBA", (self.initial_image_width, self.initial_image_width), (0, 0, 0, 0)
        )
        canvas_outer = new(
            "RGBA", (self.initial_image_width, self.initial_image_width), (0, 0, 0, 0)
        )
    ...
    def add_circle(self, size, x=0.5, y=0.5):
        radius = math.sqrt(size * self.initial_image_width**2 / math.pi)
        x *= self.initial_image_width
        y *= self.initial_image_width
        self.draw.ellipse(
    ...
    def add_square(self, size, x=0.5, y=0.5):
        side = math.sqrt(size * self.initial_image_width**2)
        x *= self.initial_image_width
        y *= self.initial_image_width
        half_side = side / 2
    ...
    def add_rectangle(self, size, x=0.5, y=0.5, t=2):
        ...
        size = size * self.initial_image_width**2
        width = (size / t) ** 0.5
        height = t * width
