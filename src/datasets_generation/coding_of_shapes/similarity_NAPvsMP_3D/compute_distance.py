import pathlib
from src.datasets_generation.coding_of_shapes.similarity_NAPvsMP_3D.generate_dataset import (
    generate_all,
)
...
for p in pretraining:
    compute_distance(
        ...
        saving_folders=dict(result_folder=f"results/coding_of_shapes/NAPvsMP_3D/{p}"),
