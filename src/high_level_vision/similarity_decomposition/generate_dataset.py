...
def make_one(params_dict):
    ...
    # name the file using the size of the shapes and the decoder_jastrow factor
...
if __name__ == "__main__":
    ...
    combinations_unfamiliar *= int(
        target_image_pairs_num / len(combinations_unfamiliar)
    )
