...
#
# import torch.nn
# from src.ebbinghaus.generate_datasets import (
...
#     RegressionDataset("./data/ebbinghaus/test_random_data"), "test"
# )
# test_dataset_small = fix_dataset(
#     RegressionDataset("./data/ebbinghaus/test_small_flankers_data"), "test_small"
# )
# test_dataset_big = fix_dataset(
#     RegressionDataset("./data/ebbinghaus/test_big_flankers_data"), "test_big"
# )
#
# num_decoders = len(config.net.decoders)
#
