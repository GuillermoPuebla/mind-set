# """
# This tests for the decoder_ebbinghaus illusion. Run it after having run "train".
...
#
# import torch.nn
# from src.decoder_ebbinghaus.generate_datasets import (
...
#     RegressionDataset("./data/decoder_ebbinghaus/test_random_data"), "test"
# )
# test_dataset_small = fix_dataset(
#     RegressionDataset("./data/decoder_ebbinghaus/test_small_flankers_data"), "test_small"
# )
# test_dataset_big = fix_dataset(
#     RegressionDataset("./data/decoder_ebbinghaus/test_big_flankers_data"), "test_big"
# )
#
# num_decoders = len(config.net.decoders)
#
