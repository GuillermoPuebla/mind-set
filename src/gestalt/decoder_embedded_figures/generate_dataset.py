...
from src.gestalt.decoder_embedded_figures.utils import DrawEmbeddedFigures
...
def generate_all(
    ...
    output_folder = (
        pathlib.Path("data/gestalt/decoder_embedded_figures/")
    ...
    for cond in ["train", "test"]:
        ...
        for s in tqdm(shapes):
            ...
            for i in tqdm(range(N)):
                ...
                img = transforms.CenterCrop(canvas_size[0])(img)
