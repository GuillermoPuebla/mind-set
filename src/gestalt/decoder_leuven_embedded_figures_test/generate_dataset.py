...
"""
Using the dataset from Downloaded from https://figshare.com/articles/dataset/Leuven_Embedded_Figures_Test_Target_Shapes/3807885 (shapes) and here https://figshare.com/articles/dataset/Leuven_Embedded_Figures_Test_Context_Shapes/3807894 (embedded shapes). These dataset should already be in the assets/decoder_leuven_embedded_figures_test folder 
"""
...
def generate(Ntrain, Ntest):
    left_ds = pathlib.Path("assets/decoder_leuven_embedded_figures_test")
    ...
    output_folder = pathlib.Path("data/gestalt/decoder_leuven_embedded_figures_test/")
